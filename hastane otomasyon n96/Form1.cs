...
namespace hastane_otomasyon_n96
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            Hasta hasta1 = new Hasta(1, "İlayda Daban", "65483215", "Göz", false, new DateTime(2023, 11, 05));
            Hasta hasta2 = new Hasta(2, "Beyzanur Tanyeli", "536254254", "Kulak-Burun-Boğaz", true, new DateTime(2023, 10, 05));
            Hasta hasta3 = new Hasta(3, "Melek Erişgin", "65483215", "Dahiliye", false, new DateTime(2023, 11, 15));
            Hasta hasta4 = new Hasta(4, "Yasemin Bayat", "5425784454", "Göz", true, new DateTime(2023, 09, 05));
        ...
        private void dataGridView1_SelectionChanged(object sender, EventArgs e)
        {
            if(dataGridView1.SelectedRows.Count > 0)
            {
                //DataGridView üzerindeki seçili satırı Hasta türünde alır.
